...
/**
 * @author bibhas [Jul 13, 2012]
 * @email bibhas.das@deri.org
 *
 */
public class TestSparqlToDGSQueryManager {
  ...
  public void setUp() throws Exception {
    ast = null;
    AnalyticsClassAttributes.initClassAttributes(Arrays
        .asList(AnalyticsClassAttributes.DEFAULT_CLASS_ATTRIBUTE));
  ...
  public void testPOFTargetIsLeaf() throws Exception {
      ...
      SparqlToDGSQueryManager sqr = new SparqlToDGSQueryManager();
      sqr.load(query);
  
      final String[] vars = filter(ASTVarGenerator.getCurrentVarNames(), "s", "p", "o", "s2");
      assertEquals(2, vars.length);
      
      final String dgsQuery = AST2TextTranslator.translate(sqr.getPipelineObject().getAst());
      final String expected = "SELECT DISTINCT ?POF ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " FROM <" + AnalyticsVocab.GRAPH_SUMMARY_GRAPH + "> \n" +
                              "WHERE {\n" +
                              "FILTER (!isLITERAL(?o ))  ?" + vars[0] + " <" + AnalyticsVocab.EDGE_SOURCE + "> ?s .\n" +
                              "  ?" + vars[0] + " <" + AnalyticsVocab.EDGE_TARGET + "> ?o .\n" +
                              "  ?" + vars[0] + " <" + AnalyticsVocab.LABEL + "> ?p .\n" +
                              "FILTER (!isLITERAL(?o ))  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.EDGE_SOURCE + "> ?s2 .\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.EDGE_TARGET + "> ?o .\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.LABEL + "> ?POF .\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.CARDINALITY + "> ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " .\n" +
                              "}\n";
  ...
  @Test
    ...
    throws Exception {
      ...
      final String expected = "SELECT DISTINCT ?POF ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " FROM <" + AnalyticsVocab.GRAPH_SUMMARY_GRAPH + "> \n" +
                              "WHERE {\n{\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.CARDINALITY + "> ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " .\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.EDGE_PUBLISHED_IN + "> ?POF .\n" +
                              "}\n}\n";
      assertEquals(expected, dgsQuery);
    }
    ...
    throws Exception {
      ...
      vars[2] = SparqlToDGSQueryInterface.POF_RESOURCE; // This is changed by the class SparqlTranslationProcessor.ChangeToPofRessource
      final String dgsQuery = AST2TextTranslator.translate(sqr.getPipelineObject().getAst());
      final String expected = "SELECT DISTINCT ?POF ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + vars[2] + " FROM <" + AnalyticsVocab.GRAPH_SUMMARY_GRAPH + "> \n" +
                              "WHERE {\n" +
                              ...
                              "  ?" + vars[2] + " <" + AnalyticsVocab.CARDINALITY + "> ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " .\n" +
                              "}\n";
      assertEquals(expected, dgsQuery);
    }
    ...
    throws Exception {
      ...
      final String[] vars = filter(ASTVarGenerator.getCurrentVarNames(), "s");
      assertEquals(3, vars.length);
      vars[1] = SparqlToDGSQueryInterface.POF_RESOURCE; // This is changed by the class SparqlTranslationProcessor.ChangeToPofRessource
      final String dgsQuery = AST2TextTranslator.translate(sqr.getPipelineObject().getAst());
      final String expected = "SELECT DISTINCT ?POF ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + vars[1] + " FROM <" + AnalyticsVocab.GRAPH_SUMMARY_GRAPH + "> \n" +
                              "WHERE {\n" +
                              ...
                              "  ?" + vars[1] + " <" + AnalyticsVocab.CARDINALITY + "> ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " .\n" +
    ...
    throws Exception {
      ...
      assertEquals(4, vars.length);
      final String dgsQuery = AST2TextTranslator.translate(sqr.getPipelineObject().getAst());
      final String expected = "SELECT DISTINCT ?POF ?" + SparqlToDGSQueryInterface.CLASS_ATTRIBUTE_CARD_VAR + " ?" + SparqlToDGSQueryInterface.CLASS_ATTRIBUTE_LABEL_VAR + " ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " FROM <" + AnalyticsVocab.GRAPH_SUMMARY_GRAPH + "> \n" +
                              "WHERE {\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.LABEL + "> ?" + vars[0] + " .\n" +
                              "  ?" + vars[0] + " <" + AnalyticsVocab.LABEL + "> ?POF .\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.CARDINALITY + "> ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " .\n" +
                              "  ?" + vars[0] + " <" + AnalyticsVocab.TYPE + "> ?" + vars[1] + " .\n" +
                              "  ?" + vars[1] + " <" + AnalyticsVocab.CARDINALITY + "> ?" + SparqlToDGSQueryInterface.CLASS_ATTRIBUTE_CARD_VAR + " .\n" +
                              "  ?" + vars[1] + " <" + AnalyticsVocab.LABEL + "> ?" + SparqlToDGSQueryInterface.CLASS_ATTRIBUTE_LABEL_VAR + " .\n" +
                              "  ?" + vars[2] + " <" + AnalyticsVocab.EDGE_SOURCE + "> ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " .\n" +
                              "  ?" + vars[2] + " <" + AnalyticsVocab.EDGE_TARGET + "> \"" + SparqlTranslationProcessor.BLANK_NODE_COLLECTION + "\" .\n" +
                              "  ?" + vars[2] + " <" + AnalyticsVocab.LABEL + "> <name> .\n" +
                              "  ?" + vars[3] + " <" + AnalyticsVocab.EDGE_SOURCE + "> ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " .\n" +
                              "  ?" + vars[3] + " <" + AnalyticsVocab.EDGE_TARGET + "> \"" + SparqlTranslationProcessor.BLANK_NODE_COLLECTION + "\" .\n" +
                              "  ?" + vars[3] + " <" + AnalyticsVocab.LABEL + "> <age> .\n" +
                              "}\n";
      assertEquals(expected, dgsQuery);
    ...
    // TODO: Check what VarsToProject used to do in the previous version
    @Ignore
    @Test
    ...
    throws Exception {
      ...
      ast = SyntaxTreeBuilder.parseQuery(query);
      SparqlToDGSQueryManager sqr = new SparqlToDGSQueryManager();
      sqr.load(query,Arrays.asList("n"));
      
      final String[] vars = filter(ASTVarGenerator.getCurrentVarNames(), "s", "n", "o");
      assertEquals(3, vars.length);
      vars[2] = SparqlToDGSQueryInterface.POF_RESOURCE; // This is changed by the class SparqlTranslationProcessor.ChangeToPofRessource
      final String dgsQuery = AST2TextTranslator.translate(sqr.getPipelineObject().getAst());
      final String expected = "SELECT DISTINCT ?n ?POF ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + vars[2] + " FROM <" + AnalyticsVocab.GRAPH_SUMMARY_GRAPH + "> \n" +
                              "WHERE {\n" +
                              "  ?s <" + AnalyticsVocab.LABEL + "> ?" + vars[0] + " .\n" +
                              "  ?" + vars[0] + " <" + AnalyticsVocab.LABEL + "> <Person> .\n" +
                              "  ?" + vars[1] + " <" + AnalyticsVocab.EDGE_SOURCE + "> ?s .\n" +
    ...
    throws Exception {
      ...
      vars[2] = SparqlToDGSQueryInterface.POF_RESOURCE; // This is changed by the class SparqlTranslationProcessor.ChangeToPofRessource
      final String dgsQuery = AST2TextTranslator.translate(sqr.getPipelineObject().getAst());
      final String expected = "SELECT DISTINCT ?POF ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + vars[2] + " FROM <http://sindice.com/analytics> \n" +
                              "WHERE {\n" +
    ...
    throws Exception {
      ...
      final String dgsQuery = AST2TextTranslator.translate(sqr.getPipelineObject().getAst());
      final String expected = "SELECT DISTINCT ?POF ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " FROM <http://sindice.com/analytics> \n" +
                              "WHERE {\n" +
                              "{\n  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.DOMAIN_URI + "> ?" + SyntaxTreeBuilder.PointOfFocus + " .\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.CARDINALITY + "> ?" + SparqlToDGSQueryInterface.CARDINALITY_VAR + " .\n" +
                              "  ?" + SparqlToDGSQueryInterface.POF_RESOURCE + " <" + AnalyticsVocab.LABEL + "> ?" + vars[0] + " .\n" +
                              "  ?" + vars[0] + " <" + AnalyticsVocab.LABEL + "> <Person> .\n" +
                              "}\n" +
