...
/**
 * Changed the Sesame SimpleNode class to add code specific for the
 * SparQLed use case
 */
...
implements Node {
  ...
  public void removeChildren(Collection<? extends Node> toRemove) {
    children.removeAll(toRemove);
  }

  public void removeChildren(Class<? extends Node> type) {
    for (Node n : jjtGetChildren(type)) {
      children.remove(n);
    }
  }
  ...
  public void removeNode() {
    ...
    for (Node childNode : children) {
      childNode.jjtSetParent(parent);
    }
  }

  public void setWithinRecommendationScope() {
    withinRecScope = true;
  }

  public boolean isWithinRecommendationScope() {
    return withinRecScope;
  }
