 ...
 */
public class NativeSingleLabelledTest {
  protected Logger _logger;

  @Before
  public void initLogger() {
    _logger = Logger.getLogger(NativeSingleLabelledTest.class);
  ...
  public void testQueryNative() {
    ...
    try {
      q = new NativeSingleLabelledQuery(new DumpString(),
          "/tmp/testUNIT/nativestoresingle");
      try {
        q.stopConnexion();
  ...
  public void testAddFileToRepository() {
    ...
    try {
      ...
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle5");
      try {
  ...
  public void testAddxml() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle25");
  ...
  public void testSetPaginationName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle6");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetPaginationPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle8");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetGraphName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle14");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testCreateAndSetGraph() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d,
          "/tmp/testUNIT/nativestoresingle14a");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
  ...
  public void testCreateAndSetWrongGraphName() {
    ...
    try {
      q = new NativeSingleLabelledQuery(d,
          "/tmp/testUNIT/nativestoresingle14b");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testCreateGraphAskAllName() {
    ...
    try {
      q = new NativeSingleLabelledQuery(d,
          "/tmp/testUNIT/nativestoresingle14c");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testUnsetGraphName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle15");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetGraphPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle16");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testCreateAndSetWrongGraphPred() {
    ...
    try {
      q = new NativeSingleLabelledQuery(d,
          "/tmp/testUNIT/nativestoresingle16a");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testCreateGraphAskAllPred() {
    ...
    try {
      q = new NativeSingleLabelledQuery(d,
          "/tmp/testUNIT/nativestoresingle16b");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testUnsetGraphPred() {
    ...
    try {
      q = new NativeSingleLabelledQuery(d,
          "/tmp/testUNIT/nativestoresingle17c");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testGetName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle18");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testGetPredicate() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle19");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameMultipleDomain() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle20");
  ...
  public void testPredMultipleDomain() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle21");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameBlankNode() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle22");
  ...
  public void testPredBlankNode() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle23");
      q.addFileToRepository("src/test/resources/unit_test_blank.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testPredMultipleDomainOneCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle26");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
    ...
    try {
      String ref = "http://www.w3.org/1999/02/22-rdf-syntax-ns#type\t\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>\t\"\"Human\"\"\tNothing\n"
          + "http://ogp.me/ns#like\t\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>\t\"\"Human\"\"\tNothing\n"
          + "http://opengraphprotocol.org/schema/type\t\"1\"^^<http://www.w3.org/2001/XMLSchema#integer>\t\"\"Human\"\"\tNothing\n";
  ...
  public void testNameMultipleDomainInvalidCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle27");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testPredMultipleDomainInvalidCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle28");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testStopConnexion() {
    ...
    try {
      ...
      q = new NativeSingleLabelledQuery(d, "/tmp/testUNIT/nativestoresingle24");
      q.stopConnexion();
    } catch (Exception e) {
      _logger.error(e.getMessage());
