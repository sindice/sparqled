 ...
 */
public class MemoryMultipleLabelledTest {
  protected Logger _logger;

  @Before
  public void initLogger() {
    _logger = Logger.getLogger(MemoryMultipleLabelledTest.class);
  ...
  public void testQueryMemory() {
    ...
    try {
      q = new MemoryMultiLabelledQuery(new DumpString(),
          "/tmp/testUNIT/memorystore");
      try {
        q.stopConnexion();
  ...
  public void testMakeGroupConcat() {
    ...
    try {
      ...
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore3");
    } catch (Exception e) {
    }
  ...
  public void testAddxml() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore25");
  ...
  public void testSetPaginationName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore6");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetPaginationPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore8");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetGraphName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore14");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testCreateAndSetGraph() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore14a");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
  ...
  public void testCreateAndSetWrongGraphName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore14b");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testCreateGraphAskAllName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore14c");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testUnsetGraphName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore15");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetGraphPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore16");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testCreateAndSetWrongGraphPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore16a");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testCreateGraphAskAllPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore16b");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3, NTriplesUtil.parseResource(
              "<http://sparql.sindice.org>", new MemValueFactory()));
    } catch (Exception e) {
  ...
  public void testUnsetGraphPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore17c");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testGetName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore18");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testGetPredicate() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore19");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameMultipleDomain() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore20");
  ...
  public void testPredMultipleDomain() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore21");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameBlankNode() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore22");
  ...
  public void testPredBlankNode() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore23");
      q.addFileToRepository("src/test/resources/unit_test_blank.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testStopConnexion() {
    ...
    try {
      Dump d = new DumpString();
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore24");
      q.stopConnexion();
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testPredMultipleDomainOneCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore26");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameMultipleDomainInvalidCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore27");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testPredMultipleDomainInvalidCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new MemoryMultiLabelledQuery(d, "/tmp/testUNIT/memorystore28");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
