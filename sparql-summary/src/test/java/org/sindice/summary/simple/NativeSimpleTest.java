...
public class NativeSimpleTest {
  ...
  public void initLogger() {
    _logger = Logger.getLogger(NativeSimpleTest.class);
  ...
  public void testQueryNative() {
    ...
    try {
      q = new NativeSimpleQuery(new DumpString(),
  ...
  public void testAddFileToRepository() {
    ...
    try {
      ...
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle5");
      try {
  ...
  public void testAddxml() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle25");
  ...
  public void testSetPaginationName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle6");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetPaginationPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle8");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetGraphName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle14");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testUnsetGraphName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle15");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testSetGraphPred() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle16");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testGetName() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle18");
      q.addFileToRepository("src/test/resources/unit_test_name.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testGetPredicate() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle19");
      q.addFileToRepository("src/test/resources/unit_test_pred.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameMultipleDomain() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle20");
  ...
  public void testPredMultipleDomain() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle21");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameBlankNode() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle22");
  ...
  public void testPredBlankNode() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle23");
      q.addFileToRepository("src/test/resources/unit_test_blank.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testPredMultipleDomainOneCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle26");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testNameMultipleDomainInvalidCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle27");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testPredMultipleDomainInvalidCA() {
    ...
    DumpString d = new DumpString();
    try {
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle28");
      q.addFileToRepository("src/test/resources/unit_test_multidomain.nt",
          RDFFormat.N3);
    } catch (Exception e) {
      _logger.error(e.getMessage());
  ...
  public void testStopConnexion() {
    ...
    try {
      ...
      q = new NativeSimpleQuery(d, "/tmp/testUNIT/nativestoresingle24");
      q.stopConnexion();
    } catch (Exception e) {
      _logger.error(e.getMessage());
