 ...
 * 
 */
public class NativeSingleLabelledQuery extends AbstractSingleLabelledQuery {

  /**
   * This constructor load a local SPRAQL repository in a NativeRepository on
   ...
   */
  public NativeSingleLabelledQuery(Dump d, String memoryStoreLocation)
      throws RepositoryException, RDFParseException, IOException,
      SesameBackendException {
    super(d);
    _repository = SesameBackendFactory.getDgsBackend(BackendType.NATIVE,
        memoryStoreLocation);
   ...
   * @throws SesameBackendException
   */
  public NativeSingleLabelledQuery(String memoryStoreLocation)
      throws RepositoryException, RDFParseException, IOException,
      SesameBackendException {
    super();
    _repository = SesameBackendFactory.getDgsBackend(BackendType.NATIVE,
