 ...
 */
public class MemorySingleLabelledQuery extends AbstractSingleLabelledQuery {

  /**
   * This constructor load a local SPRAQL repository in a SailRepository on the
   * path defined by memoryStore. If there is no repository, it will be created.
   * 
   * @param d
   *          The dump object.
   * @param memoryStore
  ...
  public MemorySingleLabelledQuery(Dump d, String memoryStoreLocation)
  ...
  public MemorySingleLabelledQuery(String memoryStoreLocation)
      throws RepositoryException, RDFParseException, IOException,
      SesameBackendException {
    super();
    _repository = SesameBackendFactory.getDgsBackend(BackendType.MEMORY,
