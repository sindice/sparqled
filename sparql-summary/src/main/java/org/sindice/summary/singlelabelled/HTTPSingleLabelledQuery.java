 ...
 */
public class HTTPSingleLabelledQuery extends AbstractSingleLabelledQuery {
  /**
   ...
   */
  public HTTPSingleLabelledQuery(Dump d, String websiteURL)
   ...
   * @throws RepositoryException
   */
  public HTTPSingleLabelledQuery(String websiteURL)
      throws RepositoryException, SesameBackendException {
    super();
    _repository = SesameBackendFactory.getDgsBackend(BackendType.HTTP,
        websiteURL);
