 ...
 */
public class RDBMSSingleLabelledQuery extends AbstractSingleLabelledQuery {
  /**
   ...
   */
  public RDBMSSingleLabelledQuery(Dump d, String url, String database,
      String user, String password) throws RepositoryException,
      RDFParseException, IOException, SesameBackendException {
    super(d);
    _repository = SesameBackendFactory.getDgsBackend(BackendType.RDBMS, url,
   ...
   * @throws SesameBackendException
   */
  public RDBMSSingleLabelledQuery(String url, String database, String user,
