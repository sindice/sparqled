 ...
 * 
 */
public class HTTPVirtuosoSimpleQuery extends
    AbstractSimpleQuery {
   ...
   */
  public HTTPVirtuosoSimpleQuery(Dump d, String websiteURL,
   ...
   * @throws SesameBackendException
   */
  public HTTPVirtuosoSimpleQuery(String websiteURL, String user,
   ...
   * @throws SesameBackendException
   */
  public HTTPVirtuosoSimpleQuery(String websiteURL)
      throws RepositoryException, SesameBackendException {
    _repository = SesameBackendFactory.getDgsBackend(BackendType.HTTP,
        websiteURL);
    _repository.initConnection();
   ...
   * @throws SesameBackendException
   */
  public HTTPVirtuosoSimpleQuery(Dump d) throws RepositoryException,
      SesameBackendException {
    super(d);
  }
