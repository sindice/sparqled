 ...
 * 
 */
public class MemorySimpleQuery extends AbstractSimpleQuery {
   ...
   */
  public MemorySimpleQuery(Dump d, String memoryStoreLocation)
   ...
   * @throws SesameBackendException
   */
  public MemorySimpleQuery(String memoryStoreLocation)
      throws RepositoryException, RDFParseException, IOException,
      SesameBackendException {
    super();
    _repository = SesameBackendFactory.getDgsBackend(BackendType.MEMORY,
