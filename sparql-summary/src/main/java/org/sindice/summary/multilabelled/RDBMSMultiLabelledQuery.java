 ...
 */
public class RDBMSMultiLabelledQuery extends AbstractMultiLabelledQuery {
  /**
   ...
   */
  public RDBMSMultiLabelledQuery(Dump d, String url, String database,
   ...
   * @throws SesameBackendException
   */
  public RDBMSMultiLabelledQuery(String url, String database, String user,
