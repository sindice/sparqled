 ...
 * 
 */
public class MemoryMultiLabelledQuery extends AbstractMultiLabelledQuery {
  ...
  public MemoryMultiLabelledQuery(Dump d, String memoryStoreLocation)
  ...
  public MemoryMultiLabelledQuery(String memoryStoreLocation)
      throws RepositoryException, RDFParseException, IOException,
      SesameBackendException {
    super();
    _repository = SesameBackendFactory.getDgsBackend(BackendType.MEMORY,
