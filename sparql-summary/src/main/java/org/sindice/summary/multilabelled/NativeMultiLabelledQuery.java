 ...
 */
public class NativeMultiLabelledQuery extends AbstractMultiLabelledQuery {
   ...
   */
  public NativeMultiLabelledQuery(Dump d, String memoryStoreLocation)
   ...
   * @throws SesameBackendException
   */
  public NativeMultiLabelledQuery(String memoryStoreLocation)
      throws RepositoryException, RDFParseException, IOException,
      SesameBackendException {
    super();
    _repository = SesameBackendFactory.getDgsBackend(BackendType.NATIVE,
