 ...
 */
public class QueryHTTP extends Query {
	/**
	 ...
	 */
	public QueryHTTP(Dump d, String websiteURL) throws RepositoryException,
	 ...
	 * @throws RepositoryException
	 */
	public QueryHTTP(String websiteURL) throws RepositoryException,
	        SesameBackendException {
		super();
		_repository = SesameBackendFactory.getDgsBackend(BackendType.HTTP,
		        websiteURL);
